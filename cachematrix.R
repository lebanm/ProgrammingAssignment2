...
##
##Fork the GitHub repository containing the stub R files at https://github.com/rdpeng/ProgrammingAssignment2 to create a copy under your own account. --done
##Clone your forked GitHub repository to your computer so that you can edit the files locally on your own machine.  --git clone https://github.com/lebanm/ProgrammingAssignment2
...
## Input for this function is a matrix which can be reversibel. 
## Result is inverse matrix in cahce
## ----------------------------------------------------------------------------
...
## -------------------------lebanm  21/02/2016 --------------------------------
## Write a short comment describing this function
## This function computes the inverse of matrix from functiuon Above 
## If the inverse matrx is already calculatedthen it should retrieve the inverse from the cache.
## Buto only and the  id matrix has not changed.
## ----------------------------------------------------------------------------
cacheSolve <- function(x, ...) {
   ## Return a matrix that is the inverse of 'x'
   inverse_m <- x$getInverse()
   if (!is.null(inverse_m)) {
           #if invers_m is not null then we shoud get cachaed data
